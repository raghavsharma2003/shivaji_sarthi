        ...
        <div className="flex flex-col gap-6 animate-in fade-in slide-in-from-bottom-4 duration-500 pb-20 md:pb-6">
            ...
            <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
                <Card className="flex flex-col gap-6">
                    <div className="flex items-center justify-between">
                        <h3 className="font-semibold tracking-tight">{t.dashboard.sentimentByTopic}</h3>
                ...
                <Card className="flex flex-col gap-6">
                    <div className="flex items-center justify-between">
                        <h3 className="font-semibold tracking-tight">{t.dashboard.weeklyEngagement}</h3>
                        <TrendingUp size={16} className="text-[var(--color-muted)]" />
                    </div>
            ...
            <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
                <Card className="h-64">
                    ...
                    <h3 className="font-semibold tracking-tight">{t.dashboard.topQuestions}</h3>
                ...
                <Card className="h-64">
                    ...
                    <h3 className="font-semibold tracking-tight">{t.dashboard.reactionBreakdown}</h3>
                    <div className="flex h-full items-center justify-center text-sm text-[var(--color-muted)]">
                        <div className="flex gap-4">
                            <div className="flex items-center gap-2"><div className="w-3 h-3 rounded-full bg-[var(--color-saffron)]"></div> Agreed</div>
                            <div className="flex items-center gap-2"><div className="w-3 h-3 rounded-full bg-[var(--color-positive)]"></div> Shared</div>
                            <div className="flex items-center gap-2"><div className="w-3 h-3 rounded-full bg-[var(--color-ink-3)] border border-[var(--color-border)]"></div> Questions</div>
                        </div>
                    </div>
                </Card>
            </div>
